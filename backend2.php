...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $data .= '<tr><td>Position Applied For</td><td>' . htmlspecialchars($_POST['position']) . '</td></tr>';
    ...
    $transport = (new Swift_SmtpTransport('mail.thefernfacilityservices.co.uk', 465, 'ssl'))  // 465 is a port number okay
        ->setUsername('noreply@thefernfacilityservices.co.uk')          // c-penal : id or password
    ...
    $message = (new Swift_Message())
        ...
        ->setFrom(['noreply@thefernfacilityservices.co.uk' => 'career Form Enquiry'])       // company name
        ->setTo(['info@thefernfacilityservices.co.uk' => 'career Form Enquiry'])      // Your email id 
        ->setBody($data)
